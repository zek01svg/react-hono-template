...
>(({ leading, trailing, containerClassName, className, ...props }, ref) => {
  return (
    <div
      className={cn(
        "border-input ring-offset-background focus-within:ring-ring group flex h-10 w-full overflow-hidden rounded-md border bg-transparent text-sm focus-within:ring-2 focus-within:ring-offset-2 focus-within:outline-none",
        containerClassName,
      )}
    >
      {leading ? (
